...
def rcrack(uid,pwx,tl):
 ...
 'accept': 'text/html,application/xhtml+xml,application/xml;q=0.9,image/avif,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3;q=0.7',
    ...
    'dpr': '1.0700000524520874',
    'sec-ch-prefers-color-scheme': 'dark',
    'sec-ch-ua': '"(Not(A:Brand";v="99", "Chromium";v="114", "Google Chrome";v="114"',
    'sec-ch-ua-full-version-list': '"(Not(A:Brand";v="99.0.0.0", "Chromium";v="114.0.5748.221", "Google Chrome";v="114.0.5748.221"',
    'sec-ch-ua-mobile': '?0',
    'sec-ch-ua-model': '""',
    ...
    'user-agent': 'Mozilla/5.0 (X11; U; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/114.0.5748.221 Safari/537.36',
    'viewport-width': '848',}
